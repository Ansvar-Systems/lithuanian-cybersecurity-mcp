/**
 * SQLite database access layer for the Lithuanian Cybersecurity (NKSC) MCP server.
 *
 * Schema:
 *   - guidance    — NKSC guidelines, recommendations, and national cybersecurity standards
